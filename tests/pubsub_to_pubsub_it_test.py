...
from pubsub_to_pubsub import pipeline as pp #, schemas
from pubsub_to_bq import pipeline as pb

from utils.create_pubsub import PubSubSetupClient


INPUT_TOPIC = 'pb-input-'
OUTPUT_TOPIC = 'wordcount-input-'
INPUT_SUB = 'pn-input-sub-'
OUTPUT_SUB = 'wordcount-input-sub-'
...
class TestIT(unittest.TestCase):
    ...
    def _inject_messages(self, topic, num_messages):
    ...
    def test_pubsub_pipe_it(self):
        ...
        expected_msg = [ b'{"data": "conall_0", "created_timestamp": 1608051184, "message_id": "230115008107576214"}' ]
        ...
        extra_opts = {
            ...
            'on_success_matcher':
                all_of(state_verifier, pubsub_msg_verifier) # bigquery_verifier
        }

        # Generate input data and inject to PubSub.
        self._inject_messages(self.input_topic, DEFAULT_INPUT_NUMBERS)

        # Get pipeline options from command argument: --test-pipeline-options,
        # and start pipeline job by calling pipeline main function.
        pp.run(self.test_pipeline.get_full_options_as_args(**extra_opts))
